...
@Controller // It's a controller bc we made use of the ResponseBody annotation
public class RegistrationController {
    ...
    // Retrieving list of registrations
    ...
    // Retrieving list of registrations using projection
